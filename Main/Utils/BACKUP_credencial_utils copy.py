...
class CredencialUtils:
    ...
    def obter_credenciais(self):
        ...
        if self.validar_campos() == True:
            ...
            return
            print("Os campos devem ser preenchidos!")  #Caso falso, abre uma janela informando que os campos devem ser preenchidos.  

        # if self.user and self.senha and self.file_path: #Se todos os campos tiverem sido preenchidos
